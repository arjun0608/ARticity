            ...
            <div class="model">
                <div class="m2">
                    ...
                    if($cnt==0)
                    {
                        ...
                        { 
                    ?>
                        <img src="modelUploads/<?php echo $row['photo']; ?>">
                        <div class="img-info">
                            <div class="img-info-con">
                                <h1><?php echo $row['title']; ?></h1>
                                <span><button name="vp" value="<?php echo $row['u_id']; ?>">View Profile</button></span> 
                            </div>
                        </div>
                    <?php
                        }
                    ...
                    if(isset($_GET['search_box']))
                    {
                        if($cnt==1)
                        {
                            ...
                            $sql4 = "SELECT * FROM modelling WHERE CONCAT(u_name,title) LIKE '%$search_value%'";
                    ...
                    ?>
                                    <img src="modelUploads/<?php echo $row4['photo']; ?>">
                                    <div class="img-info">
                                        <div class="img-info-con">
                                            <h1><?php echo $songs['title']; ?></h1>
                                            <span><button name="vp" value="<?php echo $songs['u_id']; ?>">View Profile</button></span> 
                                        </div>
                                    </div>
                    <?php
                                }
