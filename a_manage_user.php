<?php
    ...
    $sql3 = "SELECT COUNT(u_id) AS Total FROM user";
    ...
    {
        $did = $_POST['d_user'];
        $sql2="DELETE FROM user WHERE u_id='$did'";
            ...
            <center>
                    <table>
                        <tr>
                            ...
                            ?>
                        <tr align="center">
                                    <td><span><?php echo $row4['u_id']; ?></span></td>
                                    <td><span><?php echo $row4['uname']; ?></span></td>
                                    <td><span><?php echo $row4['u_uname']; ?></span></td>
                                    <td><span><?php echo $row4['u_email']; ?></span></td>
                                    <td><button class="view_btn" name="v_user" value="<?php echo $row4['u_id']; ?>">View</button></td>
                                    <td><button class="delete_btn" name="d_user"value="<?php echo $row4['u_id']; ?>">Delete</button></td>
                        </tr>
                            <?php
                                }
                            ?>
