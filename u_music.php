<?php
    ...
    {   
        ...
        $song_name = $_FILES['umusic']['name'];
        $song_tmp_name = $_FILES['umusic']['tmp_name'];
        
        $img_name = $_FILES['umodel']['name'];
        $img_tmp_name = $_FILES['umodel']['tmp_name'];

        if($title!=NULL && $desp!=NULL && $song_name!=NULL && $img_name!=NULL){

            $cc_title = preg_match('/[A-Za-z]/',$title);

            if($cc_title==1){

                $folder1 = "musicUploads/";
                move_uploaded_file($song_tmp_name,$folder1.$song_name);

                $folder = "musicCoverUploads/";
                move_uploaded_file($img_tmp_name,$folder.$img_name);

                $sql="INSERT INTO u_music VALUES (NULL,'$uid','$a_name','$title','$desp','$song_name','$img_name')";
...
<body>
    ...
    <div class="content-2">
        ...
        <div class="u_music-form-box">
            ...
            <div class="music-form">
                ...
                <br>
                <div class="u_m">
                    <label for="um" name="umusic">
                        <span>Upload Music: </span><br>
                        <center>
                            <img src="Image/music-solid.svg">
                            <input type="file" accept="audio/mp3, audio/wav" id="um" name="umusic">
                            <br>
                ...
                <br><br>
                <div class="u_p">
                    <label for="up" name="umodel">
                        <span>Upload Cover Photo: </span><br>
                        <center>
                            <img src="Image/image-regular.svg">
                            <input type="file" accept="image/png, image/jpg, image/jpeg" id="up" name="umodel">
                            <br>
    ...
    <script>
        let input1 = document.getElementById("um");
        let imageName1 = document.getElementById("musicName");
        ...
        input1.addEventListener("change", ()=>{
            ...
            imageName1.innerText = inputImage.name;
        })
