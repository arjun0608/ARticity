<?php
    ...
    if(isset($_GET['wish_list'])) {
        ...
        $sql1 = "SELECT * FROM sell WHERE id=$i_id";
        ...
        $name = $row1['u_name'];
        $ser = $row1['service'];
        $prem = $row1['premium_cost'];

        $sql3 = "SELECT * FROM wishlist WHERE ser_id=$i_id AND u_id=$uid";
        $result3 = mysqli_query($con,$sql3);
        $row3 = mysqli_fetch_assoc($result3);

        if($row3==NULL) {
            $sql2 = "INSERT INTO wishlist VALUES(NULL,'$uid','$s_id','$name','$ser','$prem')";
...
<body>
    ...
    <div class="content-1">
            ...
            <div>
                <?php
                    if($cnt==1){
                        ...
                        echo "<span>Already added to the wishlist</span>";
                        echo "</div>";
                        $cnt=0;
                    }
                    if($cnt==2){
                        echo "<div class='invalid-box-1'>";
                        echo "<span>Added to the wishlist</span>";
                        echo "</div>";
                        $cnt=0;
                    }
                ?>
        ...
        <video autoplay loop muted plays-inline class="bgvideo-7">
            <source src="Image/openbg.mp4">
        </video>
        <video autoplay loop muted plays-inline class="bgvideo-8">
            <source src="Image/openbg.mp4">
        </video>
        <div class="service">
            <div class="s1">
                ...
                ?> 
                    <?php
                            ...
                            { 
                                ...
                                $sql2 = "SELECT * FROM sell WHERE u_id='$s_uid'";
                                $result2 = mysqli_query($con,$sql2);
                                $row2 = mysqli_fetch_assoc($result2);

                                $u_uid = $row['u_id'];

                                $sql10 = "SELECT * FROM user WHERE u_id='$u_uid'";
                                $result10 = mysqli_query($con,$sql10);
                                $row10 = mysqli_fetch_assoc($result10);
                    ?>
                        <tr>
                            <td class="tds1"><img src="uploads/<?php echo $row10['photo_doc']; ?>"><br><h1><?php echo $row['u_name']; ?></h1></td>
                            <td class="tds2"><span><?php echo $row['service']; ?></span></td>
                            <td class="tds3">
                                <span>Rs.<?php echo $row['premium_cost']; ?></span>
                            </td>
                            <td class="tds4">
                                <div class="wishlist">
                                    <button name="wish_list" value="<?php echo $row['id']; ?>">Add to wishlist <ion-icon name="heart"></ion-icon></button>
                                    
                                    <div class="buy">
                                        <button name="buy" value="<?php echo $row['id']; ?>">Buy <ion-icon name="cart"></ion-icon></button>
                                        <div class="icon">
                                    </div>
                                </div>
                            </td>
                ...
                <?php
                    ...
                    if(isset($_GET['search_box']))
                    {
                        if($cnt==1)
                        {
                            ...
                            $sql4 = "SELECT * FROM sell WHERE CONCAT(category,service) LIKE '%$search_value%'";
                    ...
                    ?>
                                    <tr>
                                        <td class="tds1"><img src="uploads/<?php echo $row10['photo_doc']; ?>"></h1></td>
                                        <td class="tds2"><span><?php echo $songs['service']; ?></span></td>
                                        <td class="tds3">
                                            <span>Rs.<?php echo $songs['premium_cost']; ?></span>
                                        </td>
                                        <td class="tds4">
                                            <div class="wishlist">
                                                <button name="wish_list" value="<?php echo $row4['id']; ?>">Add to wishlist <ion-icon name="heart"></ion-icon></button>
                                                
                                                <div class="buy">
                                                    <button name="buy" value="<?php echo $row4['id']; ?>">Buy <ion-icon name="cart"></ion-icon></button>
                                                    <div class="icon">
                                                </div>
                                            </div>
                                        </td>
