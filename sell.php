<?php
    ...
    {               
        ...
        $pd=$_POST['pd'];
        $pc=$_POST['pc'];
        $file_name = $_FILES['u_p_c']['name'];
        $file_tmp_name = $_FILES['u_p_c']['tmp_name'];
        $folder = "sellUploads/";
        
        if($cate!=NUll && $ser!=NULL && $desp!=NULL && $nd!=NULL && $nc!=NULL && $dd!=NULL && $dc!=NULL && $pd!=NULL && $pc!=NULL && $file_name!=NULL) {
            
            $cn_ser = preg_match('/[0-9]/',$ser);
            $cs_ser = preg_match('/[\'^£$%&*()}{@#~?><>,|=_+¬-]/',$ser);
            $cc_ser = preg_match('/[A-Za-z]/',$ser);
            
            if($cc_ser==1){
                if($cn_ser!=1) {
                    if($cs_ser!=1) {
                        move_uploaded_file($file_tmp_name,$folder.$file_name);
                        $sql="INSERT INTO sell VALUES (NULL,'$uid','$uname','$cate','$ser','$desp','$nd','$nc','$dd','$dc','$pd','$pc','$file_name')";
...
<body>
    ...
    <div class="content-6">
        ...
        <?php
            ...
            if($cnt==2){
                echo "<div class='invalid-box-1'>";
                echo "<span>Service name should not contain numbers...</span>";
                echo "</div>";
                $cnt=0;
            }
            if($cnt==9){
                echo "<div class='invalid-box-1'>";
                echo "<span>Service name should not contain special characters...</span>";
                echo "</div>";
                $cnt=0;
            }
            if($cnt==12){
        ...
        <div class="showcase">
            <center>
                <span>Just showcase what you know and earn...!</span>
            </center>
        </div>
        <div class="sell-form-box1">
            ...
            <!-- <video autoplay loop muted plays-inline class="bgvideo-6">
                <source src="Image/Black Background.mp4">
            </video> -->
            ...
            <center>
                ...
                <div class="reqi">
                    ...
                    <p>
                    1. Audio: mp3( 320kbit/s), wav <br>
                    2. Cover photo: png, jpg,jpeg
                    </p>
                </div>
                <br>
                <hr>
                <br>
                <span>Enter your service category: </span>
                ...
                <br><br>
                <span>Enter your service: </span> 
                <input type="text" name="service" value="<?php echo $ser ?>">
                <br><br>
                <span>Service Description: </span>
                <center><textarea name="ser_desp"><?php echo $desp; ?></textarea></center>
                <br>
                <div class="u_p">
                    <label for="up" name="u_p_c">
                        <span>Upload Demo: </span><br>
                        <center>
                            <img src="Image/arrow-up-from-bracket-solid.svg">
                            <input type="file" accept="image/svg, image/png, image/jpg, image/jpeg, audio/mp3, audio/wav" id="up" name="u_p_c">
                            <br>
                ...
                <div class="service-charges">
                    <div class="ser">
                        <h1>Normal:- </h1>
                        <br>
                        <span>Days: </span><input type="number" name="nd" value="<?php echo $nd; ?>">
                        <br><br>
                        <span>Cost: </span><input type="number" name="nc" value="<?php echo $nc; ?>">
                    </div>
                    <div class="ser">
                        <h1>Delux:- </h1>
                        <br>
                        <span>Days: </span><input type="number" name="dd" value="<?php echo $dd; ?>">
                        <br><br>
                        <span>Cost: </span><input type="number" name="dc" value="<?php echo $dc; ?>">
                    </div>
                    <div class="ser">
                        <h1>Premium:- </h1>
                        <br>
                        <span>Days: </span><input type="number" name="pd" value="<?php echo $pd; ?>">
                        <br><br>
                        <span>Cost: </span><input type="number" name="pc" value="<?php echo $pc; ?>">
                    </div>
                </div>
