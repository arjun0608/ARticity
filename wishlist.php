<?php
    ...
    $sql = "SELECT * FROM wishlist WHERE u_id=$uid";
    ...
    {
        $did = $_POST['dmu_user'];
        $sql2="DELETE FROM wishlist WHERE id='$did'";
                    ...
                    <table>
                        <?php
                            while($row = mysqli_fetch_assoc($result)) { 
                                ?>
                        <tr>
                            <td class="tds1"><img src="Image/Profile.jpg"><br><h1><?php echo $row['u_name']; ?></h1></td>
                            <td class="tds2"><span><?php echo $row['service']; ?></span></td>
                            <td class="tds3">
                                <span>$<?php echo $row['p_cost']; ?></span>
                            </td>
                            <td class="tds4">
                                <div class="wishlist">
                                    <button name="buy" class="b-btn" value="<?php echo $row['ser_id']; ?>"><span>Buy</span><ion-icon name="cart-sharp"></ion-icon></button>
                                </div>
                                
                            </td>
                            <td class="tds5">
                                <div class="delete_w">
                                    <button name="dmu_user" class="d-btn" value="<?php echo $row['id']; ?>"><span>Delete<ion-icon name="trash-sharp"></ion-icon></span></button>
                                </div>
                            </td>
                        </tr>
                        <?php
