<?php
    ...
    $sql = "SELECT * FROM modelling WHERE u_id = $iid";
    $result = mysqli_query($con,$sql);

    $sql1 = "SELECT * FROM user WHERE u_id = $iid";
    ...
    <div class="content-2">
        ...
        <div class="service-info">
            <div class="si-box">
                ...
                <div class="si-info">
                    <span>Name: <?php echo $row1['u_uname']?></span>  
                    <br>
                    <span>Bio: <?php echo $row1['u_bio']?></span>
                </div>
            </div>
            <div class="ch-d">
                <span>Walk the Walk with <?php echo $row1['u_uname']?> </span>
            </div>
