<?php
    ...
    $sql3 = "SELECT COUNT(u_id) AS Total FROM sell";
    $result3 = mysqli_query($con,$sql3);
    $value = mysqli_fetch_assoc($result3);
    ...
    {
        $did = $_POST['d_user'];
        $sql2="DELETE FROM sell WHERE id='$did'";
        $result2=mysqli_query($con,$sql2);

        $sql4="DELETE FROM wishlist WHERE ser_id='$did'";
                        ...
                        <div class="box">
                            ...
                            <div class="box-info">
                                <center>
                                    ...
                                    <br>
                                    <h1>Total Available Services</h1>
                                </center>
                            </div>
                        </div>
                    </div>
            ...
            <center>
                    <table>
                        <tr>
                            ...
                            <th><span>Normal Days</span></th>
                            <th><span>Normal Cost</span></th>
                            <th><span>Deluxe Days</span></th>
                            <th><span>Deluxe Cost</span></th>
                            <th><span>Premium Days</span></th>
                            <th><span>Premium Cost</span></th>
                        ...
                        <tr align="center">
                                    ...
                                    <td><span><?php echo $row['u_name']; ?></span></td>
                                    <td><span><?php echo $row['category']; ?></span></td>
                                    <td><span><?php echo $row['normal_days']; ?></span></td>
                                    <td><span><?php echo $row['normal_cost']; ?></span></td>
                                    <td><span><?php echo $row['deluxe_days']; ?></span></td>
                                    <td><span><?php echo $row['deluxe_cost']; ?></span></td>
                                    <td><span><?php echo $row['premium_days']; ?></span></td>
                                    <td><span><?php echo $row['premium_cost']; ?></span></td>
                                    <td><button class="view_btn" name="v_user" value="<?php echo $row['id']; ?>">View</button></td>
                                    <td><button class="delete_btn" name="d_user"value="<?php echo $row['id']; ?>">Delete</button></td>
                        </tr>
                            <?php
                                }
                            ?>
