<?php
  include "connect.php";
  session_start();
  $uuid =  $_SESSION['a_mana_s_u_id'];
  $suid = $_SESSION['s_ser'];
  $pv_id = $_SESSION['p_ser'];
  ...
  if($pv_id!=NULL)
  {
    $sql2 = "SELECT * FROM payment WHERE id='$pv_id'";
  ...
  if($uuid!=NULL)
  {
    $var1 = $_SESSION['a_mana_s_u_id'];
  }

    $sql1 = "SELECT * FROM sell WHERE id='$var1'";
            ...
            <div class="right_content">
                  ...
                  ?>
                        <div class="view-user">
                          ...
                          <span class="cls1">
                            Id:<input type="text" name="v_id" value="<?php echo $row2['id']; ?>" readonly>
                            <br><br>
                            Service Provider Name:<input type="text" name="v_name" value="<?php echo $row2['s_p_name']; ?>" readonly>
                            <br><br>
                            Category:<input type="text" name="v_title" value="<?php echo $row2['s_category']; ?>" readonly>
                            <br><br>
                            Amount:<input type="text" name="v_amt" value="Rs.<?php echo $row2['amount']?>" readonly> 
                            <br><br>
                          </span>
                        </div>
                        <?php
                      ...
                      <div class="view-user">
                        ...
                        <span class="cls1">
                          ...
                          Artist Name:<input type="text" name="v_name" value="<?php echo $row1['u_name']; ?>" readonly>
                            <br><br>
                            Category:<input type="text" name="v_title" value="<?php echo $row1['category']; ?>" readonly>
                            <br><br>
                            Description: <br><textarea name="v_desp" readonly><?php echo $row1['desp']?></textarea> 
                            <br><br>
                          </span>
                      </div>
                    <?php
                        }
                        $_SESSION['a_mana_s_u_id']=0;
                        $_SESSION['s_ser']=0;
                        $_SESSION['p_ser']=0;
                    ?>
                </form>
