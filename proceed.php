...
<body>
    ...
    <div class="content">
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="proceed.php">Buy</a>
                                <a href="proceed.php">Sell</a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="dropdown1">
                            ...
                            <div class="dropdown-content1">
                                <a href="proceed.php">Music</a>
                                <a href="proceed.php">Modelling</a>
                                <a href="proceed.php">Dance</a>
                                <a href="proceed.php">Photography</a>
                                <a href="proceed.php">Singing</a>
                                <a href="proceed.php">Gaming</a>
                                <a href="proceed.php">Coding</a>
                                <a href="proceed.php">News</a>
                                <a href="proceed.php">Makeup</a>
                                <a href="proceed.php">Fashion Designing</a>
                                <a href="proceed.php">Vlogging</a>
                                <a href="proceed.php">Blogging</a>
                                <a href="proceed.php">Comedy</a>
                                <a href="proceed.php">Painting</a>
                                <a href="proceed.php">Sketching</a>
                                <a href="proceed.php">Calligraphy</a>
                            </div>
                        </div>
                    </li>
        ...
        <center>
            ...
            <div class="lgn-btn">
                    <button name="mn-lgn">Login</button>
            </div>
            <div class="space">
