<?php
    ...
    $sql1 = "SELECT * FROM sell WHERE u_id=$uid";
    ...
    if(isset($_POST['del'])) {
        ...
        $sql2 = "DELETE FROM sell WHERE id='$s_id'";
        ...
        <div class="service2">
            <div class="s1">
                    <table>
                        ...
                        ?>
                        <tr>
                            <td class="tds1"><img src="uploads/<?php echo $row4['photo_doc']?>"><br><h1><?php echo $row1['u_name']; ?></h1></td>
                            <td class="tds2"><span><?php echo $row1['service']; ?></span></td>
                            <td class="tds3">
                                <span>$<?php echo $row1['premium_cost']; ?></span>
                            </td>
                            <td class="tds4">
                                <div class="wishlist">
                                    <!-- <button name="buy" class="b-btn" value=""><span>Buy</span><ion-icon name="cart-sharp"></ion-icon></button> -->
                                    <div class="delete_w">
                                        <button name="del" class="d-btn" value="<?php echo $row1['id']; ?>"><span>Delete<ion-icon name="trash-sharp"></ion-icon></span></button>
                                    </div>
                                    <td class="tds4">
                                    <div class="wishlist">
                                        <button name="buy" class="b-btn" value="<?php echo $row1['id']; ?>"><span>View</span><ion-icon name="eye-outline"></ion-icon></button>
                                    </div>
                            ...
                            <!-- <td class="tds5">
                                <div class="delete_w">
                                    <button name="" class="d-btn"><span>Delete<ion-icon name="trash-sharp"></ion-icon></span></button>
                                </div>
                            </td> -->
                        </tr>
                        <?php
