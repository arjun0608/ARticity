<?php
    ...
    $sql = "SELECT * FROM payment WHERE u_id=$uid";
                    ...
                    <table>
                        <?php
                            while($row = mysqli_fetch_assoc($result)) { 
                                $spName = $row['s_p_name'];
                                $sql4 = "SELECT * FROM user WHERE u_uname='$spName'";
                                $result4 = mysqli_query($con,$sql4);
                                $row4 = mysqli_fetch_assoc($result4);
                        ?>
                        <tr>
                            <td class="tds1"><img src="uploads/<?php echo $row4['photo_doc']?>"><br><h1><?php echo $row['s_p_name']; ?></h1></td>
                            <td class="tds2"><span><?php echo $row['s_category']; ?></span></td>
                            <td class="tds3">
                                <span>$<?php echo $row['amount']; ?></span>
                            </td>
                            <td class="tds4">
                                <div class="wishlist">
                                    <button name="buy" class="b-btn" value="<?php echo $row['sp_id']; ?>"><span>Buy</span><ion-icon name="cart-sharp"></ion-icon></button>
                                </div>
