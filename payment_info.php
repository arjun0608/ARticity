<?php
    ...
    {
        $sql1 = "INSERT INTO payment VALUES(NULL,'$sp_id','$uid','$uname','$s_p','$category','$cost')";
...
body {
    background-image: linear-gradient(180deg, white, purple);
}
.pay-box {
    padding:2vw;
}
...
.pay-btn button {
    ...
    margin-top:3vw;
    font-size:1.3vw;
    background-color:rgb(135, 40, 135);
    border:thin;
    color:white;
    font-family:var(--font3);
}
...
<body>
    ...
    <div class="content">
        ...
        <div class="payment-info-box">
            <center><h1>Your Service Information</h1></center>
            <div class="pay-box">
                <br>
                <span>Name:</span>
                ...
                <br><br><br>
                <center><span>Service Package</span></center><br>
                <span>Service provided by: </span>
                <input type="text" value="<?php echo $s_p;?>" readonly>
                <br><br>
                <div class="no-ta">
                    <div class="no">
                        <span>No. of days: </span>
                        <input type="text" value="<?php echo $days;?> days" readonly>
                    </div>
                    <div class="ta">
                        <span>Total Amount: </span>
                        <input type="text" value="Rs.<?php echo $cost;?>/-" readonly>
                    </div>
                </div>
                <center>
                    <div class="pay-btn">
                        <button name="p_pay" id="rzp-button1" class="btn btn-outline-dark btn-lg"><i class="fas fa-money-bill"></i>Proceed to Pay</button>
                    </div>
                </center>
            </div>  
        </div>
    ...
    <script>
        const amt = <?php echo $cost; ?>
        // console.log(amt);
        var options = {
            "key": "rzp_test_7CZuyu7HrfRgTl", // Enter the Key ID generated from the Dashboard
            "amount": ""+amt*100,
            "currency": "INR",
            "description": "ARticity",
            "image": "https://s3.amazonaws.com/rzp-mobile/images/rzp.jpg",
            "prefill":
            {
            "email": "articity@gmail.com",
